...
export class TweetComponent implements OnInit {
  ...
  @Input()
  description="This is Lemon. He was found as a stray right at the end of 2021. He has a very awkward elbow fracture that will require surgery and possibly amputation";
