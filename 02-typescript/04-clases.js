...
var Usuario = /** @class */ (function (_super) {
    ...
    function Usuario(nombreParametro, apellidoParametro, cedula, //si ponemos un modificador de acceso, se vuelve propiedad de la clase
    estadoCivil) {
...
var miguel = new Usuario('Miguel', 'Munoz', '1723171714', 'soltero');
console.log(miguel);
